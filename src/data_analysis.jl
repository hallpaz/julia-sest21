...
# ╔═╡ 2fa41ba8-87dd-4bc3-a6c4-2089a122e3c1
begin
	using Chain
	using CSV
	using DataFrames
...
# ╔═╡ 2b67c13d-595b-4ee5-bc03-82e5355ed3fa
using Plots, PlotlyJS

# ╔═╡ 0b2ea5db-03cb-4b52-8683-34eafc189484
md"""
# Análise de Dados Eleitorais

Vamos conduzir uma análise de dados usando dados abertos sobre as eleições disponíveis no portal de dados abertos do Tribunal Superior Eleitoral. Nossa análise será baseada no conteúdo do vídeo abaixo, piublicado no canal Programação Dinâmica em 28 de novembro de 2020 e implementado na linguagem Python. 

Assim, buscamos entender como tarefas comuns realizadas no ecossistema de dados de Python poderiam ser realizadas em Julia.
"""

# ╔═╡ c90f4a8e-3021-11ec-2e09-551d6c541824
html"""
<iframe width="560" height="315" src="https://www.youtube.com/embed/ZZMEUFyKqpE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
"""

# ╔═╡ 6d6ad596-0d44-4ba2-8f1a-2e8162366e46
# constantes
begin
	URL_CANDIDATOS20200 = "https://cdn.tse.jus.br/estatistica/sead/odsele/consulta_cand/consulta_cand_2020.zip"
	DATA_DIR = "/Users/hallpaz/Workspace/cursos/julia-sest21/data"
end
...
# ╔═╡ 15b79a98-81f3-402a-9f41-dfb323bb2c51
md"""
##### TODO: ler diretamente do zip
"""

# ╔═╡ eeea85e4-53da-49c9-8fe1-0d568c23e33e
path_resultados2020 = joinpath(
			DATA_DIR, 
...
# ╔═╡ 077dcac8-6b0c-43d6-9247-3ce21d8c1b81
df_2020[df_2020.NM_UE .!= df_2020.NM_MUNICIPIO, :]
...
colunas_de_interesse = [
	...
	:SG_UE, :NM_UE, :NR_ZONA, :DS_CARGO, 
	:NR_CANDIDATO, :NM_URNA_CANDIDATO, :NR_PARTIDO, 
	:SG_PARTIDO, :QT_VOTOS_NOMINAIS, :CD_MUNICIPIO]

# ╔═╡ 626584bd-19ed-46a2-badf-e2a25c78f4b9
md"""
###### Exercício candidatos com candidatura regular
Mostre que não há candidatos com descrição da situação da candidatura (**DS\_SITUACAO\_CANDIDATURA**) diferete de "APTO".

###### Exercício registro de nome social

Mostre que não há candidatos com nome social (**NM\_SOCIAL\_CANDIDATO**) diferete de "#NULO#".
"""
...
# ╔═╡ 0f56f055-9d57-4e66-b898-1cca50a64896
df_2020[df_2020.NM_TIPO_ELEICAO .!= "Eleição Ordinária", :]
...
# ╔═╡ 5733bec8-4aa5-4f68-aa00-c1deacd8f24a
groupby(df_vereador, :SG_UE)

# ╔═╡ c3afba4b-ba7d-40ed-8c77-263da6cea25c
df_2turno = df_candidatos2020[df_candidatos2020.NR_TURNO .== 2, :]
...
# ╔═╡ 4d9a7cc4-daae-4e9b-bd8c-0ce65f3a64ee
df_1turno = df_candidatos2020[df_candidatos2020.NR_TURNO .== 1, :]

# ╔═╡ 73c70882-d958-47e2-acdf-728fea0c0626
md"""
##### TODO:
Fazer 1o e 2o turno como views (sem cópia)
"""
...
# ╔═╡ 6c9d9c7c-d2e9-4218-9c5e-fa01ef883c7e
df_prefeitos

# ╔═╡ 3bb565d0-52a2-4596-99ea-78d98440590a
first(df_prefeitos, 3)

# ╔═╡ 0ce8ad47-b429-4c61-9c53-b7fe23aa2d37
...
md"""
Quantos não tiveram nenhum voto?
"""
